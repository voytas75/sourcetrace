...
FIXTURE_PATH = Path(__file__).resolve().parents[2] / "fixtures" / "v2" / "authority_relevance_outcome_eval_v1.json"
...
def test_authority_relevance_outcome_eval_v1_cases() -> None:
