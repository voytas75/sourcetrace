...
FIXTURE_PATH = Path(__file__).resolve().parents[2] / "fixtures" / "v2" / "quality_regression_pack_v4.json"
...
def test_quality_regression_pack_v4_cases() -> None:
    for case in _load_cases():
        ...
        assert trust_payload["selected_evidence_count"] == 2
        assert trust_payload["candidate_count"] == len(artifact.evidence_candidates)
