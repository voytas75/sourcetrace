            ...
            messages=(
                LlmMessage(
                    ...
                    content=(
                        ...
                        "Preserve attribution when it is part of the claim-bearing wording, "
                        "including patterns such as X said, according to, analysts said, "
                        "or named institution ownership. "
                        "Keep attribution-bearing wording attached to the claim when it helps "
                        "the claim stay decision-ready and source-owned. "
                        "Do not rewrite attributed claims into unattributed propositions. "
                        "For sentences with while, despite, although, though, however, or but, "
                        "where the secondary clause is attribution-only context and does not own "
                        "the claim, return the main factual proposition as the claim. "
                        ...
                        "when possible, while preserving attribution if it materially owns the statement. "
                        "For a single analytical proposition expressed through linked metrics, "
                        "consequences, or dependent tail clauses in the same sentence, prefer one grouped claim. "
                        "Do not split short dependent fragments such as repair timelines, cost tails, "
                        "or linked consequence clauses into standalone claims when they belong to the same "
                        "analytical proposition. "
                        "For example, keep 'The strike reportedly knocked out 17% of global LNG supply "
                        "and may cost QatarEnergy about $20bn in annual revenues, with repairs taking 3 to 5 years.' "
                        "as one grouped claim rather than separate subclaims. "
